                ...
                <tbody>
                    {
                        orders.map(order =>
                            <tr key={order._id}>
                                ...
                                <td><button type="button" className="btn btn-primary btn-sm px-3">{order.status}</button>
                                    {
                                        order.status === 'Pending' && <button type="button" onClick={() => handleStatus(order._id)} className="btn btn-success btn-sm px-3 ms-1">Approved</button>
                                    }</td>
