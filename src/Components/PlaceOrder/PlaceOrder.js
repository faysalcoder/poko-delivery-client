...
const PlaceOrder = () => {
    ...
    const handleOrder = e => {
        ...
        fetch("https://infinite-savannah-50361.herokuapp.com/neworder", {
            method: 'POST',
            headers: {
    ...
    useEffect(() => {
        fetch(`https://infinite-savannah-50361.herokuapp.com/placeorder/${id}`)
            .then(res => res.json())
                        ...
                        <div className='d-block mx-auto'>
                            <Card style={{ width: '18rem' }}>
                                ...
                                <Card.Body className=" text-center">
                                    ...
                                    <Card.Text>
                                        <span className="fs-2">Price: ${placeOrder.price}</span>
                                    </Card.Text>
